...
//        fprintf(stderr, "Debug enabed\r\n");
//        csp_debug_toggle_level(3);
//        csp_debug_toggle_level(4);
//
//        fprintf(stderr, "Conn table\r\n");
//        csp_conn_print_table();
//
//        fprintf(stderr, "Route table\r\n");
...
//    }
    ...
    csp_thread_create(task_client, "CLIENT", 800, NULL, 0, &handle_client);
    /* Server */
    //fprintf(stderr, "Starting Server task\r\n");
    csp_thread_handle_t handle_server;
    csp_thread_create(task_server, "SERVER", 800, NULL, 0, &handle_server);
